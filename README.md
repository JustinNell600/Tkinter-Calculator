...
A lightweight and user-friendly **desktop calculator** built using **Python** and **Tkinter**. This project aim was for me to learn tkinter to start developing python programs with tkinter GUI's.

## 🚀 How to Run

1. Ensure **Python 3.x** is installed
2. Install Tkinter if your distribution does not include it
3. Run the script:
